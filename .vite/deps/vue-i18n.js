...
var CORE_WARN_CODES_EXTEND_POINT = 10;
var warnMessages = {
...
function getCurrentInstance2() {
    ...
    if (key in vue_runtime_esm_bundler_exports) {
        return vue_runtime_esm_bundler_exports[key];
    } else {
...
function defineCoreMissingHandler(missing) {
    return ((ctx, locale, key, type) => {
        return missing(locale, key, getCurrentInstance2() || void 0, type);
    });
}
var getMetaInfo = () => {
